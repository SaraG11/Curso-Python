...
print("Esta es mi primer lista:", my_list)
# print(len(my_list))
...
my_other_list.append("SG") #un append lo va insertar al final de una lista
# print(my_other_list)
...
#estructuras colas
print(my_list.pop()) #elimina el ultimo registro o desapila la lista 
print(my_list)


my_pop_element = my_list.pop(2) #el numero del elemento que se quiere desapilar recordando que la lista inicia con 0
...
my_list.clear() #no habrá ningun elemento de la lista, eliminamos los elementos de la lista
print(my_list)
print(my_new_list)

my_new_list.reverse() #oredena la lista al inverso, el ultimo elemento pasa a ser el primero
print(my_new_list)

my_new_list.sort() #ordena, criterios para ordenar de mayor a menor
print(my_new_list)

print(my_new_list.index(25)) #retorna el indice del valor que se le pasa como parametro
